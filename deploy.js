...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    '/home/ubuntu/starter-node-angular-starter-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf starter-node-angular-starter-temp && mkdir starter-node-angular-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r starter-node-angular-starter-temp/* starter-node-angular-starter/ && rm -rf starter-node-angular-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd starter-node-angular-starter && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `starter-node-angular-starter-temp` folder.');
